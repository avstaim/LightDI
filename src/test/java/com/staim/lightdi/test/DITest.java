...
public class DITest {
    ...
    public void testDI() {
        ...
        t1 = LightDI.instance().getInstance(TestInterface1.class);
        Assert.assertNotNull(t1);
        ...
        TestInterface2 t2 = LightDI.instance().getInstance(TestInterface2.class);
        ...
        t2 = LightDI.instance().getInstance(TestInterface2.class);
        Assert.assertNotNull(t2);
        ...
        TestInterface4 t4 = LightDI.instance().getInstance(TestInterface4.class);
        ...
        TestInterface5 t5 =  LightDI.instance().getInstance(TestInterface5.class);
        ...
        TestInterface5 t5a =  LightDI.instance().getInstance(TestInterface5.class);
